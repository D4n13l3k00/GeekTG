...
class LoaderMod(loader.Module):
    ...
    strings = {
        ...
        "select_preset": "<tg-emoji emoji-id='5213205860498549992'>⚠️</tg-emoji> <b>Please select a preset</b>",
        ...
        "provide_module": "<tg-emoji emoji-id='5213205860498549992'>⚠️</tg-emoji> <b>Provide a module to load</b>",
        ...
        "no_modules": "<tg-emoji emoji-id='5213205860498549992'>⚠️</tg-emoji> <b>You have no custom modules!</b>",
        ...
        try:
            try:
                ...
                rc = await utils.install_requirements(
                    requirements, user_install=USER_INSTALL
                )
