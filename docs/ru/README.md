...
Пользовательская документация (команды, скриншоты, видео) когда-то жила
на `docs.geektg.tk`. Этот хост сейчас offline. Новая user-документация
будет приземляться сюда обычным Markdown — PR'ы приветствуются.
